    ...
    public partial class firtsMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Electronics", "High-performance laptop", "Laptop", 1500 },
                    { 2, "Electronics", "High-performance laptop", "Tv", 1000 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "johndoe@example.com", "John Doe", "qwerty123", "Customer" },
                    { 2, "Jack@x.com", "Jack", "qwerty123", "Customer" }
                });
